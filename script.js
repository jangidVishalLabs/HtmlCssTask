...
class CardsCarousel {
    constructor() {
        ...
        // Style references
        this.listGap = document.defaultView.getComputedStyle(this.list).gap;
    ...
    updateCarousel() {
        ...
        const cardWidth = firstCard ? firstCard.getBoundingClientRect().width || 0 : 0;

        // Get gap from computed style
        const gap = parseFloat(this.listGap) || 0;
